	...
	return (
		<div className="w-full h-screen py-8 px-8 md:py-20 md:px-20 bg-green-primary">
			<div className="w-full h-full flex flex-row ">
				<div className="w-full md:w-1/2 h-full px-4 md:px-20 py-20 flex items-center justify-center rounded-2xl md:rounded-e-none md:rounded-s-2xl backdrop-blur-lg bg-opacity-70 bg-slate-100">
